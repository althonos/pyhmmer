...
class SequenceFile(typing.ContextManager[SequenceFile], typing.Iterator[Sequence]):
    ...
    alphabet: typing.Optional[Alphabet]
    @classmethod
    def parse(cls, buffer: BUFFER, format: str, *, alphabet: typing.Optional[Alphabet] = None) -> Sequence: ...
    @classmethod
    ...
    @property
    def digital(self) -> bool: ...
    def read(self, skip_info: bool = False, skip_sequence: bool = False) -> typing.Optional[Sequence]: ...
    def readinto(self, seq: Sequence, skip_info: bool = False, skip_sequence: bool = False) -> typing.Optional[Sequence]: ...
    def close(self) -> None: ...
