...
class GeneticCode(object):
    def __init__(self, nt_alphabet: Alphabet = ..., aa_alphabet: Alphabet = ..., translation_table: int = 1) -> None: ...
    @property
    ...
    def translation(self, codon: str) -> str: ...
    def translate(self, sequence: DigitalSequence) -> DigitalSequence: ...
    def translate_block(self, block: DigitalSequenceBlock) -> DigitalSequenceBlock: ...
