...
class Vector(typing.Sequence[_T], typing.Generic[_T], abc.ABC):
    ...
    @abc.abstractmethod
    def __init__(self, iterable: typing.Optional[typing.Collection[_T]] = None): ...
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    def __iadd__(self: _V, other: _T) -> _V: ...
    @abc.abstractmethod
    def __imul__(self: _V, other: _T) -> _V: ...
    @abc.abstractmethod
...
class VectorF(Vector[float]):
    ...
    def __iadd__(self, other: float) -> VectorF: ...
    def __imul__(self, other: float) -> VectorF: ...
    def __matmul__(self, other: VectorF) -> float: ...
    @property
    def __array_interface__(self) -> typing.Dict[str, object]: ...
    def argmax(self) -> int: ...
    def argmin(self) -> int: ...
