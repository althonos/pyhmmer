...
class _EvalueParameters:
    def __init__(self, owner: typing.Union[Profile, HMM]) -> None: ...
    def __copy__(self) -> _EvalueParameters: ...
    def __str__(self) -> str: ...
    def __eq__(self, other: object) -> bool: ...
    @property
...
class HMM(object):
    alphabet: Alphabet
    evalue_parameters: _EvalueParameters
    cutoffs: _Cutoffs
    ...
    @property
    def creation_time(self) -> typing.Optional[bytes]: ...
    @creation_time.setter
    def creation_time(self, ctime: typing.Optional[bytes]) -> None: ...
    def copy(self) -> HMM: ...
