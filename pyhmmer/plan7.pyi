...
class OptimizedProfileBlock(typing.MutableSequence[OptimizedProfile]):
    def __init__(self, iterable: typing.Iterable[OptimizedProfile] = ()) -> None: ...
    def __len__(self) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, optimized_profile: typing.Iterable[OptimizedProfile]) -> None: ...
    @typing.overload
    ...
    def index(self, optimized_profile: OptimizedProfile, start: int = 0, end: int = sys.maxsize) -> int: ...
