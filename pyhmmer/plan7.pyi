...
class Cutoffs(object):
    ...
    @gathering.setter
    def gathering(self, gathering: typing.Optional[typing.Tuple[float, float]]) -> None: ...
    @gathering.deleter
...
class TopHits(typing.Sequence[Hit]):
    ...
    @property
    def hits_reported(self) -> bool: ...
    @property
    def hits_included(self) -> bool: ...
    @property
    def strand(self) -> typing.Optional[STRAND]: ...
    @property
    ...
    def merge(self, other: TopHits) -> TopHits: ...
    def to_msa(
        self,
        alphabet: Alphabet,
        trim: bool = False,
