...
class TextSequenceBlock(SequenceBlock[TextSequence]):
    ...
    def digitize(self, alphabet: ABC) -> DigitalSequenceBlock[ABC]: ...
...
class SSIReader(object):
    ...
    @property
    def primary_keys(self) -> typing.Sequence[str]: ...
