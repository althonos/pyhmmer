...
BUFFER = typing.Union[bytes, bytearray, memoryview, Buffer]
...
class VectorD(Vector[float]):
    ...
    def __add__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
    def __iadd__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
    def __sub__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
    def __isub__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
    def __mul__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
    def __imul__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
    def __truediv__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
    def __itruediv__(self, other: typing.Union[float, VectorD]) -> VectorD: ...
...
class MatrixD(Matrix[float]):
    ...
    def __add__(self, other: typing.Union[float, MatrixD]) -> MatrixD: ...
    def __iadd__(self, other: typing.Union[float, MatrixD]) -> MatrixD: ...
    def __mul__(self, other: typing.Union[float, MatrixD]) -> MatrixD: ...
    def __imul__(self, other: typing.Union[float, MatrixD]) -> MatrixD: ...
    def __repr__(self) -> str: ...
    def __sizeof__(self) -> int: ...
    def argmax(self) -> typing.Tuple[int, int]: ...
    def argmin(self) -> typing.Tuple[int, int]: ...
...
class MSA(abc.ABC, typing.Sized):
    ...
    def __len__(self) -> int: ...
    @property
    def accession(self) -> typing.Optional[str]: ...
    @accession.setter
    def accession(self, accession: typing.Union[str, bytes, None]) -> None: ...
    @property
    def author(self) -> typing.Optional[str]: ...
    @author.setter
    def author(self, author: typing.Union[str, bytes, None]) -> None: ...
    @property
    def name(self) -> typing.Optional[str]: ...
    @name.setter
    def name(self, name: typing.Union[str, bytes, None]) -> None: ...
    @property
    def description(self) -> typing.Optional[str]: ...
    @description.setter
    def description(self, description: typing.Union[str, bytes, None]) -> None: ...
    @property
    def names(self) -> typing.Tuple[str]: ...
    @property
    def reference(self) -> typing.Optional[str]: ...
    @reference.setter
    def reference(self, reference: typing.Union[str, bytes, None]) -> None: ...
    @property
    def model_mask(self) -> typing.Optional[str]: ...
    @model_mask.setter
    def model_mask(self, model_mask: typing.Union[str, bytes, None]) -> None: ...
    @property
    def secondary_structure(self) -> typing.Optional[str]: ...
    @secondary_structure.setter
    def secondary_structure(self, secondary_structure: typing.Union[str, bytes, None]) -> None: ...
    @property
    def surface_accessibility(self) -> typing.Optional[str]: ...
    @surface_accessibility.setter
    def surface_accessibility(self, surface_accessibility: typing.Union[str, bytes, None]) -> None: ...
    @property
    def posterior_probabilities(self) -> typing.Optional[str]: ...
    @posterior_probabilities.setter
    def posterior_probabilities(self, posterior_probabilities: typing.Union[str, bytes, None]) -> None: ...
    @property
...
class TextMSA(MSA):
    def __init__(
        self,
        *,
        name: typing.Union[str, bytes, None] = None,
        description: typing.Union[str, bytes, None] = None,
        accession: typing.Union[str, bytes, None] = None,
        sequences: typing.Optional[typing.Iterable[TextSequence]] = None,
        author: typing.Union[str, bytes, None] = None,
    ) -> None: ...
...
class DigitalMSA(MSA):
    ...
    @property
    def indexed(self) -> typing.Mapping[str, DigitalSequence]: ...
    def compute_weights(
        self, 
        method: COMPUTE_WEIGHTS_METHOD = "pb", 
        max_identity: float = 0.62,
...
class Sequence(typing.Sized, abc.ABC):
    ...
    @accession.setter
    def accession(self, accession: typing.Union[str, Buffer]) -> None: ...
    @property
    def description(self) -> str: ...
    @description.setter
    def description(self, description: typing.Union[str, Buffer]) -> None: ...
    @property
    def name(self) -> str: ...
    @name.setter
    def name(self, name: typing.Union[str, Buffer]) -> None: ...
    @property
    def source(self) -> str: ...
    @source.setter
...
class TextSequence(Sequence):
    ...
    def __init__(
        ...
        *,
        ...
        source: typing.Union[str, bytes, None] = None,
        residue_markups: typing.Optional[typing.Mapping[str, str]] = None,
    ) -> None: ...
    def __reduce__(
        self,
...
class DigitalSequence(Sequence):
    ...
    def __init__(
        ...
        *,
        ...
        source: typing.Union[str, bytes, None] = None,
        residue_markups: typing.Optional[typing.Dict[str, str]] = None,
    ) -> None: ...
    def __reduce__(
        self,
