...
class Cutoffs(object):
    def __init__(self, owner: Union[Profile, HMM]) -> None: ...
...
class HMM(object):
    ...
    def __init__(self, alphabet: Alphabet, M: int, name: str) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __copy__(self) -> HMM: ...
    def __deepcopy__(self, memo: Dict[int, object]) -> HMM: ...
    ...
    def set_consensus(self, sequence: Optional[DigitalSequence]) -> None: ...
    def to_profile(
        self,
...
class HMMPressedFile(typing.Iterator[OptimizedProfile]):
    ...
    def name(self) -> str: ...
    def close(self) -> None: ...
    def read(self) -> Optional[OptimizedProfile]: ...
    def rewind(self) -> None: ...
...
class IterativeSearch(typing.Iterator[IterationResult]):
    pipeline: Pipeline
    builder: Builder
    query: Union[DigitalSequence, HMM]
    converged: bool
    ...
    def __init__(
        ...
        query: Union[DigitalSequence, HMM],
        targets: DigitalSequenceBlock,
        select_hits: Optional[typing.Callable[[TopHits[HMM]], None]] = None,
    ) -> None: ...
...
class OptimizedProfile(object):
    ...
    def __deepcopy__(self, memo: Dict[int, object]) -> OptimizedProfile: ...
    def __eq__(self, other: object) -> bool: ...
    def __sizeof__(self) -> int: ...
    @property
    def M(self) -> int: ...
    ...
    def ssv_filter(self, seq: DigitalSequence) -> Optional[float]: ...

class OptimizedProfileBlock(typing.MutableSequence[OptimizedProfile]):
    alphabet: Alphabet
    def __init__(
        self, alphabet: Alphabet, iterable: Iterable[OptimizedProfile] = ()
    ) -> None: ...
    def __len__(self) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(
        self, index: slice, optimized_profile: Iterable[OptimizedProfile]
    ) -> None: ...
    @typing.overload
    ...
    def extend(self, iterable: Iterable[OptimizedProfile]) -> None: ...
...
class Offsets(object):
    def __init__(self, owner: Union[Profile, OptimizedProfile]) -> None: ...
...
class Pipeline(object):
    ...
    def search_hmm(
        self,
        query: Union[HMM, Profile, OptimizedProfile],
        sequences: Union[DigitalSequenceBlock, SequenceFile[DigitalSequence]],
    ) -> TopHits[Union[HMM, Profile, OptimizedProfile]]: ...
    def search_msa(
        self,
        query: DigitalMSA,
        sequences: Union[DigitalSequenceBlock, SequenceFile[DigitalSequence]],
    ...
    def scan_seq(
        self,
        query: DigitalSequence,
        optimized_profiles: Union[OptimizedProfileBlock, HMMPressedFile],
    ) -> TopHits[DigitalSequence]: ...
    def iterate_seq(
        self,
        query: DigitalSequence,
        ...
        builder: Optional[Builder] = None,
        select_hits: Optional[typing.Callable[[TopHits[DigitalSequence]], None]] = None,
    ) -> IterativeSearch: ...
    def iterate_hmm(
        self,
        query: HMM,
...
class Profile(object):
    ...
    def __deepcopy__(self, memo: Dict[int, object]) -> Profile: ...
    def __eq__(self, other: object) -> bool: ...
    def __sizeof__(self) -> int: ...
    @property
    def M(self) -> int: ...
