...
class Background(typing.Generic[ABC]):
    ...
    def null1(self, sequence: Sequence) -> float: ...
...
class HMM(typing.Generic[ABC]):
    ...
    def emit_sequence(self, randomness: Union[Randomness, int, None] = None) -> DigitalSequence[ABC]: ...
    def emit_alignment(self, N: int, randomness: Union[Randomness, int, None] = None) -> DigitalMSA[ABC]:
...
class HMMFile(
    ...
    @property
    def alphabet(self) -> Optional[ABC]: ...
    def close(self) -> None: ...
...
class Profile(typing.Generic[ABC]):
    ...
    def multihit(self, multihit: bool) -> None: ...
    @property
    def emission_scores(self) -> MatrixF: ...
    def clear(self) -> None: ...
    def configure(
        self,
        hmm: HMM[ABC],
